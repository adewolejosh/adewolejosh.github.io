<template>
    <div class="m-5">
        <div class="cont-container">
            ...
            <div class="mt-5 mb-xl-5 me-xl-5 ms-5" id="about">
                <h4 class="text-center" id="headerz"> About Me </h4>
                <hr/>
                <div class="mt-5 me-xl-5 ms-xl-5 mb-5" id="about-note">
                    <p>
                        ...
                        and/or Fullstack Engineering roles, here's <a href="https://drive.google.com/file/d/1if4CHW_6asGoB3kIFTn7bx_2UhC1Vngj/view?usp=sharing">My Resume</a>
                    </p>
                    <br>
                    <p>
